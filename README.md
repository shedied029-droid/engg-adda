deployment f*cked up on render and i'm not wasting my time fixing it.

if you want to see it work, take the front end and back end code, throw it in vs code, install whatever dependencies it screams for, and run it on localhost yourself.
